...
public final class ReadingEntityFromMongoDBReplicaSet {
	private static final Logger LOG = Logger.getLogger(kina.examples.java.ReadingEntityFromMongoDBReplicaSet.class);
    ...
    public static void doMain(String[] args) {
        ...
        MongoKinaConfig inputConfigEntity = MongoConfigFactory.createMongoDB(MessageEntity.class).host(host1).host(host2).host(host3)
