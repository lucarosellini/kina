...
public class MongoEntityRDDTest implements Serializable {
    ...
    public void testWritingRDD() {
        ...
        MongoKinaConfig<MessageTestEntity> outputConfigEntity = MongoConfigFactory.createMongoDB(MessageTestEntity.class)
...
//      tests List<subDocuments>
    ...
    public void testInputColums() {
        ...
        MongoKinaConfig<BookEntity> inputConfigEntity2 = MongoConfigFactory.createMongoDB(BookEntity.class)
        ...
        MongoKinaConfig<BookEntity> inputConfigEntity3 = MongoConfigFactory.createMongoDB(BookEntity.class)
