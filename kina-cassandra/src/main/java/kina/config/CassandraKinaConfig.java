...
/**
 * Defines the public methods that each Kina Cassandra configuration object should implement.
 */
public interface CassandraKinaConfig<T> extends KinaConfig<T, CassandraKinaConfig<T>> {
     ...
     * @throws kina.exceptions.IndexNotFoundException if the specified field has not been indexed in
     *                                                               Cassandra.
     * @throws kina.exceptions.NoSuchFieldException   if the specified field is not a valid column in
     *                                                               Cassandra.
     */
     ...
     * @return this object.
     */
    public abstract CassandraKinaConfig<T> partitioner(String partitionerClassName);
     ...
     * @return this object.
     */
    public abstract CassandraKinaConfig<T> keyspace(String keyspace);
     ...
     * @return this object.
     */
    public abstract CassandraKinaConfig<T> rpcPort(Integer port);
     ...
     * @return this object.
     */
    public abstract CassandraKinaConfig<T> cqlPort(Integer port);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> readConsistencyLevel(String level);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> writeConsistencyLevel(String level);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> bisectFactor(int bisectFactor);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> table(String table);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> columnFamily(String columnFamily);
     ...
     * @return this object.
     */
    public abstract CassandraKinaConfig<T> batchSize(int batchSize);
     ...
     * @return this configuration object.
     */
    public abstract CassandraKinaConfig<T> createTableOnWrite(Boolean createTableOnWrite);
     ...
     */
    public abstract CassandraKinaConfig<T> session(Session session);
}
