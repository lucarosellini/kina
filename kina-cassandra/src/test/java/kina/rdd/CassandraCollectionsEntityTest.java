...
public class CassandraCollectionsEntityTest extends CassandraRDDTest<Cql3CollectionsTestEntity> {
    ...
    @Override
    protected CassandraKinaConfig<Cql3CollectionsTestEntity> initReadConfig() {
        CassandraKinaConfig<Cql3CollectionsTestEntity> config = CassandraConfigFactory.create(Cql3CollectionsTestEntity.class)
    ...
    @Override
    protected CassandraKinaConfig<Cql3CollectionsTestEntity> initWriteConfig() {
        CassandraKinaConfig<Cql3CollectionsTestEntity> writeConfig = CassandraConfigFactory.createWriteConfig
    ...
    public void testSaveToCassandra() {
        ...
        try {
            ...
            fail();
        } catch (kina.exceptions.IOException e) {
            // ok
            logger.info("Correctly catched IOException: " + e.getMessage());
