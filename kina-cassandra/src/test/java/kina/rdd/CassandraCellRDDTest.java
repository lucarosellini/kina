...
public class CassandraCellRDDTest extends CassandraRDDTest<Cells> {
    ...
    protected CassandraKinaConfig<Cells> initReadConfig() {
        CassandraKinaConfig<Cells> rddConfig = CassandraConfigFactory.create().host(Constants.DEFAULT_CASSANDRA_HOST)
    ...
    public void testCountWithInputColumns() {
        ...
        CassandraKinaConfig<Cells> tmpConfig = CassandraConfigFactory.create().host(Constants.DEFAULT_CASSANDRA_HOST)
    ...
    protected CassandraKinaConfig<Cells> initWriteConfig() {
        CassandraKinaConfig<Cells> writeConfig = CassandraConfigFactory.createWriteConfig().host(Constants
